    ...
    <>
      ...
      <div className="space-y-3 mb-6">
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-[#21262d] hover:bg-[#30363d] border border-[#30363d] rounded-lg text-white text-sm font-medium transition-colors disabled:opacity-50"
        >
          {oauthLoading === 'google'
      ...
      <div className="space-y-4">
        <div>
          ...
          <input type="email"
            className="w-full px-3 py-2 bg-[#0f1117] border border-[#30363d] rounded-lg text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-brand-500 text-sm"
      ...
      <p className="text-center text-sm text-gray-500 mt-6">
        ...
        <Link href="/auth/signup" className="text-brand-400 font-medium hover:underline">Sign up</Link>
      </p>
    </>
  )
}
